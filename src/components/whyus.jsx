      ...
      <div className="max-w-[1180px] mx-auto px-[28px]">
        <div className="mb-[56px]">
          <h2 className="text-[28px] md:text-[42px] font-[700] text-white">
            Designed for reliable <span className="gold-text">ASIC miner repairs.</span>.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[28px]">
          {points.map((point) => (
            <div
              key={point.title}
              className="border-t-2 border-gold-dim pt-[20px]"
            >
              <h3 className="text-[16.5px] font-[600] text-white mb-[10px]">
                {point.title}
              </h3>
