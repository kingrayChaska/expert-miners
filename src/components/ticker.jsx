...
const Ticker = () => {
  ...
  return (
    <div className="border-t border-b border-navy-line py-[20px] overflow-hidden bg-navy-panel">
      <div
        className="flex w-max items-center gap-[48px] whitespace-nowrap font-mono text-[13px] text-[#9aa0c2] tracking-[0.05em] uppercase will-change-transform ticker-track"
      >
